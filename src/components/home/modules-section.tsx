    ...
    <section className="modules-section">
      <div className="modules-section__container">
        ...
        <RevealStagger className="modules-section__grid">
          {modules.map(mod => (
            <Card key={mod.href} className="modules-section__card">
              <CardHeader>
                <CardTitle className="modules-section__card-title">{mod.title}</CardTitle>
              </CardHeader>
              <CardContent className="modules-section__card-content">{mod.description}</CardContent>
              <CardFooter className="modules-section__card-footer">
                <Link
                  href={mod.href}
                  className={cn(buttonVariants({ variant: 'link' }), 'modules-section__card-link')}
                >
                  Czytaj więcej →
                </Link>
              </CardFooter>
        ...
        <p className="modules-section__footer-link">
          <Link href="/zastosowanie" className="modules-section__footer-link-anchor">
