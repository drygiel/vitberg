export const siteConfig = {
  ...
  social: {
    ...
    instagram: "https://www.instagram.com/vitberg",
    youtube:
      "https://www.youtube.com/channel/UC6T_Z-aatuXWTH0LynfBWbw",
  },
} as const;
...
export const modules = [
  ...
  },
  {
    title: "Ręce",
    description:
      "Pomoc przy problemach z nadgarstkami, łokciami, reumatyzmie i słabym chwycie.",
    href: "/modul-rece",
  },
  {
    title: "Brzuch",
...
export const visitSteps = [
  ...
  },
  {
    ...
    title: "Konsultacja",
    description:
      "Na miejscu pytamy o Twoje dolegliwości i dobieramy odpowiedni program.",
  },
  {
    step: 3,
    title: "Bezpłatny zabieg",
    description:
      "Testujesz materac Vitberg RS2 w komfortowych warunkach (ok. 20–30 minut).",
  },
  {
    step: 4,
    title: "Plan działania",
    description:
      "Doradzamy, jak możesz kontynuować terapię — również w domu.",
  },
] as const;
