...
const PAGES = [
  ...
  {
    url: 'https://www.vitberg.com/vitberg-rs/aparat-bazowy-vitberg-rs.html',
    file: 'aparat-bazowy.md',
  },
  ...
  {
    url: 'https://www.vitberg.com/vitberg-rs/modul-kolana-vitberg-rs.html',
    file: 'modul-kolana.md',
  },
  ...
  {
    url: 'https://www.vitberg.com/vitberg-rs/modul-brzuch-vitberg-rs.html',
    file: 'modul-brzuch.md',
  },
];
...
async function scrapePage(page) {
  try {
    ...
    $(
      'script, style, iframe, noscript, header, footer, #header, #footer, aside, nav, .breadcrumb, .cookieconsent, #cc-main',
    ).remove();
